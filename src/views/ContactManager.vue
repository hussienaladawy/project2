...
<div class="row">
  <div class="col display: flex">
    ...
    <p class="fst-italic">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nostrum cum sunt deleniti, natus ducimus iste eius sed omnis animi necessitatibus fuga voluptatum quibusdam soluta perspiciatis optio fugiat eum rerum. Ex.</p>
  <form action="">
<div class="row">
<div class="col-md-6">
<div class="row">
